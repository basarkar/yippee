//Usage java GetURL http://songs.pk/ songs.pk
import java.util.*;
import java.io.*;
import java.net.URL;
import java.net.URI;
...
//         System.setProperty("http.proxyPort", "8080");
         ...
         arr.add(url);
         while(!arr.isEmpty()){
         url = arr.remove(0).toString(); // System.out.println("Now Processing: "+url);
               ...
               if(t == HTML.Tag.A)  {
                  ...
                  while(attrNames.hasMoreElements())    {
                      ...
                      if("href".equals(key.toString())) {
                          ...
                          GetURL.temp_arr.add(a.getAttribute(key).toString());
                      }
                  }
               }
            }
